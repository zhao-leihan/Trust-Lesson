...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900 overflow-hidden">
      {/* ========================================================= */}
      {/* HERO SECTION - Exact styling from the reference image     */}
      {/* ========================================================= */}
      <section className="relative min-h-screen flex flex-col justify-between pt-28 pb-16 px-6 sm:px-12 lg:px-16 overflow-hidden bg-slate-950">
        ...
        <div className="relative z-10 max-w-xl lg:max-w-2xl my-auto pt-10 sm:pt-14">
          <Reveal direction="down">
            {/* Pill Badge matching reference: ★ Learn • Grow • Earn */}
      ...
      {/* ========================================================= */}
      {/* SECTION 2: MEET THE LESSON MONSTERS (Crisp White & Purple)*/}
      {/* ========================================================= */}
      ...
      {/* ========================================================= */}
      {/* SECTION 3: COMMUNITY TESTIMONIALS & MASCOTS (White/Pastel)*/}
      {/* ========================================================= */}
      ...
      {/* ========================================================= */}
      {/* SECTION 4: HOW TRUST ESCROW WORKS (Clean White)           */}
      {/* ========================================================= */}

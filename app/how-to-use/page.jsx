        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 text-center space-y-6">
          ...
          <Reveal direction="up" delay={350}>
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              ...
              <a
                href="#mentor-flow"
                className="px-6 py-3 rounded-full bg-white hover:bg-purple-50 text-purple-700 border-2 border-purple-200 font-extrabold text-xs sm:text-sm shadow-xs hover:shadow-sm hover:scale-105 transition-all flex items-center gap-2 cursor-pointer active:scale-95"
              >
                <Sparkles size={16} />
              ...
              <a
                ...
                className="px-6 py-3 rounded-full bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border-2 border-emerald-200 font-extrabold text-xs sm:text-sm shadow-xs hover:shadow-sm hover:scale-105 transition-all flex items-center gap-2 cursor-pointer active:scale-95"
              >
                <DollarSign size={16} />
      ...
      <section id="student-flow" className="py-20 px-4 sm:px-6 max-w-6xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Reveal direction="up" delay={100}>
            <div className="h-full p-6 rounded-3xl bg-white border-2 border-slate-200 hover:border-purple-500 hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group shadow-xs">
              <div className="space-y-3">
                <div className="w-10 h-10 rounded-2xl bg-purple-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-purple-600/30 group-hover:scale-110 transition-transform duration-300">
                  1
                </div>
          ...
          <Reveal direction="up" delay={200}>
            <div className="h-full p-6 rounded-3xl bg-white border-2 border-slate-200 hover:border-indigo-500 hover:shadow-xl hover:shadow-indigo-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group shadow-xs">
              <div className="space-y-3">
                <div className="w-10 h-10 rounded-2xl bg-indigo-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-indigo-600/30 group-hover:scale-110 transition-transform duration-300">
                  2
                </div>
          ...
          <Reveal direction="up" delay={300}>
            <div className="h-full p-6 rounded-3xl bg-white border-2 border-slate-200 hover:border-emerald-500 hover:shadow-xl hover:shadow-emerald-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group shadow-xs">
              <div className="space-y-3">
                <div className="w-10 h-10 rounded-2xl bg-emerald-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-emerald-600/30 group-hover:scale-110 transition-transform duration-300">
                  3
                </div>
          ...
          <Reveal direction="up" delay={600}>
            <div className="h-full p-6 rounded-3xl bg-white border-2 border-slate-200 hover:border-amber-500 hover:shadow-xl hover:shadow-amber-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group shadow-xs">
              <div className="space-y-3">
                <div className="w-10 h-10 rounded-2xl bg-amber-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-amber-600/30 group-hover:scale-110 transition-transform duration-300">
                  6
                </div>
        ...
        <Reveal direction="up" delay={300} className="text-center pt-10">
          <Link
            href="/explore"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-purple-600 hover:bg-purple-700 text-white font-extrabold text-xs shadow-md shadow-purple-600/25 hover:shadow-lg hover:shadow-purple-600/30 hover:scale-105 transition-all cursor-pointer active:scale-95"
          >
      ...
      <section id="mentor-flow" className="py-20 px-4 sm:px-6 bg-purple-50/50 border-y border-purple-100 relative">
        <div className="max-w-6xl mx-auto w-full space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Step 1 */}
            <Reveal direction="up" delay={100}>
              <div className="h-full p-6 rounded-3xl bg-white border-2 border-purple-100 hover:border-purple-500 hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group shadow-xs">
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-2xl bg-purple-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-purple-600/30 group-hover:scale-110 transition-transform duration-300">
                    1
                  </div>
            ...
            {/* Step 2 */}
            <Reveal direction="up" delay={200}>
              <div className="h-full p-6 rounded-3xl bg-white border-2 border-purple-100 hover:border-indigo-500 hover:shadow-xl hover:shadow-indigo-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group shadow-xs">
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-2xl bg-indigo-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-indigo-600/30 group-hover:scale-110 transition-transform duration-300">
                    2
                  </div>
            ...
            {/* Step 3 */}
            <Reveal direction="up" delay={300}>
              <div className="h-full p-6 rounded-3xl bg-white border-2 border-purple-100 hover:border-emerald-500 hover:shadow-xl hover:shadow-emerald-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group shadow-xs">
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-2xl bg-emerald-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-emerald-600/30 group-hover:scale-110 transition-transform duration-300">
                    3
                  </div>
            ...
            {/* Step 6 */}
            <Reveal direction="up" delay={600}>
              <div className="h-full p-6 rounded-3xl bg-white border-2 border-purple-100 hover:border-amber-500 hover:shadow-xl hover:shadow-amber-500/10 hover:-translate-y-2 transition-all duration-300 flex flex-col justify-between group shadow-xs">
                <div className="space-y-3">
                  <div className="w-10 h-10 rounded-2xl bg-amber-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-amber-600/30 group-hover:scale-110 transition-transform duration-300">
                    6
                  </div>
          ...
          <Reveal direction="up" delay={300} className="text-center pt-6">
            <Link
              ...
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-extrabold text-xs shadow-md shadow-purple-600/25 hover:shadow-lg hover:shadow-purple-600/30 hover:scale-105 transition-all cursor-pointer active:scale-95"
            >
